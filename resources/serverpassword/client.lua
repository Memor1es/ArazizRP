...
AddEventHandler("Fax:ServerPassword:ShowPasswordPrompt", function()
    local password = KeyboardInput("Saissiez le mot de passe du serveur (" .. attempts .. " essais" .. (attempts == 1 and "" or "s") .. " restants)", "", 30)
    attempts = attempts - 1
...
AddEventHandler('Fax:ServerPassword:PassedPassword', function()
    ...
    TriggerEvent('chatMessage', "^2Password correct !")
end)
