...
AddEventHandler('esx_slotmachine:sv:1', function(amount,a,b,c)
	...
	amount = tonumber(amount)
		...
		TriggerClientEvent('esx:showNotification', source, "~r~Vous n'avez pas assez de liquide~s~")
	end
end)
...
AddEventHandler('esx_slotmachine:sv:2', function(amount)
	...
	local xPlayer = ESX.GetPlayerFromId(source)
	    ...
	    TriggerClientEvent('esx:showNotification', source, "~g~Vous avez gagné ~s~ " .. amount .. "$.")
	end)
