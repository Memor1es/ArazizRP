...
AddEventHandler('esx_society:washMoney', function(society, amount)
	...
	if amount and amount > 0 and account.money >= amount then
		...
		-- if blackMoney.money < 1000 then
			--ESX.ShowNotification("Il faut minimum 1000$ d'argent sale")
			-- TriggerClientEvent("esx_blanchisseur:notify", source, "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('Nocash') .. 1000)
		-- else
			-- local bonus = math.random(0, 0)
