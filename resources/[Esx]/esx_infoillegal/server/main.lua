...
RegisterServerEvent('esx_infoillegal:Blanche')
AddEventHandler('esx_infoillegal:Blanche', function()
	local source = source
	TriggerEvent('es:getPlayerFromId', source, function(user)
		if (tonumber(user.getMoney()) >= Config.PriceBlanc) then
			user.removeMoney(Config.PriceBlanc)
			TriggerClientEvent("esx_infoillegal:Blanchiment", source)				
		else
			TriggerClientEvent("esx_infoillegal:notify", source, "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('NoCash'))
		end
	end)
...
RegisterServerEvent('esx_infoillegal:Armes')
AddEventHandler('esx_infoillegal:Armes', function()
	local source = source
	TriggerEvent('es:getPlayerFromId', source, function(user)
		if (tonumber(user.getMoney()) >= Config.PriceArmes) then
			user.removeMoney(Config.PriceArmes)
			TriggerClientEvent("esx_infoillegal:ArmesIllegales", source)				
		else
			TriggerClientEvent("esx_infoillegal:notify", source, "CHAR_LESTER_DEATHWISH", 1, _U('Notification'), false, _U('NoCash'))
		end
	end)
