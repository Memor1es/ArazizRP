...
TriggerEvent('es:addGroupCommand', 'esxban:load', "mod", function (source)
  BanListLoad        = false
...
TriggerEvent('es:addGroupCommand', 'esxban:history', "mod", function (source, args, user)
...
TriggerEvent('es:addGroupCommand', 'esxban:add', "mod", function (source, args, user)
...
TriggerEvent('es:addGroupCommand', 'esxban:addoff', "mod", function (source, args, user)
	if args ~= "" then
...
TriggerEvent('es:addGroupCommand', 'esxban:reason', "mod", function (source, args, user)
